...
<body background = "https://allfreedesigns.com/wp-content/uploads/2016/02/lace-background-10.jpg">
	...
	{ 
		...
		{ 
			...
			out.println( "<p align='center'> <a href='http://localhost:8080/336test/codyFunction/cancel_reservation_f.jsp'>Cancle Reservation</a>  </p>");
			out.println( "<p align='center'> <a href='http://localhost:8080/336test/alteredFiles/viewAccount_f.jsp'>View Account</a>  </p>");
		} 
