...
<%
		try {
			...
			if (Countrow.equals("1")) 
			{
			    ...
			    //delete the data
			    int i= stmt.executeUpdate ("delete from Customer_Representitive where CRID = ('"+CRID_b+"');");
			...
			else
			{
				...
				out.println("The CRID you want to delete is not correct, please check again.");
				out.print("<a href=" + "http://localhost:8080/336test/adminFunction/deleteCR_f.jsp><mark>back</mark></a>");
