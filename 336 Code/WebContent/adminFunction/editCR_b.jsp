...
<%
		...
		if(action.equals("1"))
		{
			...
			String strQuery = "SELECT COUNT(*) FROM Customer_Representitive where CRID=('"+oCRID_b+"');";
		    ...
		    if (Countrow.equals("1"))
		    {
		    	...
		    	int i= stmt.executeUpdate ("update Customer_Representitive set CRID = ('"+nCRID_b+"') where CRID = ('"+oCRID_b+"');");
		    	out.println("The CRID you want to edit is successfully edited.");
		    	out.print("<a href=" + "http://localhost:8080/336test/adminFunction/editCR_f.jsp><mark>back</mark></a>");
				//out.print("<a href=" + "http://localhost:8080/336test/adminFunction/addC_f.jsp><mark>back</mark></a>");
		    }
		    else
		    {
		    	//CRID is not in the database
		    	out.println("The CRID you want to edit is not in the database, please try again.");
				out.print("<a href=" + "http://localhost:8080/336test/adminFunction/editCR_f.jsp><mark>back</mark></a>");
		    }
		...
		else if(action.equals("2"))
		{
		    ...
		    if (Countrow.equals("1"))
		    {
				...
				//CRID in the database, can edit
		    	int i= stmt.executeUpdate ("update Customer_Representitive set password = ('"+nPassword_b+"') where CRID = ('"+CRID_b+"');");
